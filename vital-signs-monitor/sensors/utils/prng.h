 ...
 * @{
 *
 * The prng module offers a pseudorandom number generator based on the <code>srand()</code> and
 * <code>rand()</code> functions provided by the standard library.
 * The module allows to seed the PRNG and extract a number inside a given interval.
 */
 ...
 *               The implementation is a call to the <code>srand()</code> function
